...
@section('subtitle', 'Register a new doctor')

@section('content')
    <form method="POST" action="{{ route('admin.doctors.store') }}" enctype="multipart/form-data" class="max-w-2xl">
        @csrf
            ...
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <input
                        ...
                        placeholder="e.g. Dr. Ahmad bin Ibrahim"
                    >
                    @error('name')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        >
                        <p class="mt-1 text-xs text-gray-400">Maps doctor to a Plato facility record. Must be unique per doctor.</p>
                    ...
                    <div>
                        ...
                        >
                        <p class="mt-1 text-xs text-gray-400">Max 2MB. JPG, JPEG, PNG, or WebP. Square ratio recommended.</p>
                        @error('photo')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-400 ml-6">When checked, this doctor appears in the mobile app booking flow. Default is OFF.</p>
                    </div>
