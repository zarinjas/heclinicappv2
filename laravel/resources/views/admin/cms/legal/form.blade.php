@php $isEdit = isset($legal) && $legal->exists; @endphp
...
@section('content')
    <form method="POST"
          action="{{ $isEdit ? route('admin.cms.legal.update', $legal) : route('admin.cms.legal.store') }}"
          class="max-w-2xl">
        @csrf
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug', $legal->slug) }}"
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $legal->title) }}"
                ...
                <div>
                    ...
                    <input type="date" name="last_updated" id="last_updated" value="{{ old('last_updated', $legal->last_updated?->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <textarea name="sections_json" id="sections_json" rows="10"
                              ...
                              placeholder='[{"heading": "Section Title", "body": "Content text here."}]'>{{ old('sections_json', $isEdit ? json_encode($legal->sections, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                ...
                <label class="inline-flex items-center gap-2 cursor-pointer">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $legal->is_active ?? true) ? 'checked' : '' }}
