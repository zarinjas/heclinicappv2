        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="category_id" class="block text-sm font-medium text-[#0F1B3D] mb-1">Category</label>
                        <select
                            name="category_id"
                            id="category_id"
                            class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#00C9A7] focus:border-transparent outline-none @error('category_id') border-red-300 @enderror"
                        >
                        ...
                        <p class="mt-1 text-xs text-gray-400">
                            <a href="{{ route('admin.cms.article-categories.index') }}" class="text-[#00C9A7] hover:underline">Manage categories</a>
                        </p>
                        @error('category_id')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    <label for="is_featured" class="flex items-center gap-3 text-sm font-medium text-[#0F1B3D] cursor-pointer">
                        <input
                            type="checkbox"
                            name="is_featured"
                            id="is_featured"
                    ...
                    <p class="mt-1 text-xs text-gray-400">Featured articles are highlighted with a large banner on the home screen. Only one is shown as the top feature.</p>
                </div>
