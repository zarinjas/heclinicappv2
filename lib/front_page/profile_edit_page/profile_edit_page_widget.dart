...
class _ProfileEditPageWidgetState extends State<ProfileEditPageWidget> {
  ...
  void initState() {
    ...
    _model.dobTextController ??= TextEditingController(text: widget!.dob);
            ...
            children: [
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selectedMedia != null &&
                        ...
                        safeSetState(
                            () => _model.isDataUploading_uploadDataIej = true);
                        ...
                        try {
                          ...
                          _model.isDataUploading_uploadDataIej = false;
                        }
                        if (selectedUploadedFiles.length ==
                            selectedMedia.length) {
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadDataIej =
                      ...
                      _model.apiResultjy2 =
                          await MedicalAppsApiGroup.updateProfilCall.call(
                        authorization: 'Bearer ${FFAppState().tokenauth}',
                        avatar: _model.uploadedLocalFile_uploadDataIej,
                      );

                      if ((_model.apiResultjy2?.succeeded ?? true)) {
                        _model.img =
                            'https://hemedicalapps.com/${MedicalAppsApiGroup.updateProfilCall.avatar(
                          (_model.apiResultjy2?.jsonBody ?? ''),
                        )}';
                        safeSetState(() {});
                      }
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 10.0, 0.0),
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if ((_model.apiResultsbl?.succeeded ?? true)) {
                        _model.apiResultzu5 = await EditPatiendCall.call(
                          patientId: widget!.idplato,
                          name: _model.yournameTextController.text,
                          dob: _model.dobTextController.text,
                          address: _model.addressTextController.text,
                        );
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return WebViewAware(
                                child: AlertDialog(
                                  title: Text('Profile Updated'),
                                  content: Text('Failed Update Profile'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
