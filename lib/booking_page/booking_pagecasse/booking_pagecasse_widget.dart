...
import 'booking_pagecasse_model.dart';
export 'booking_pagecasse_model.dart';

class BookingPagecasseWidget extends StatefulWidget {
  const BookingPagecasseWidget({
    super.key,
    required this.cas,
  });
  ...
  static String routeName = 'bookingPagecasse';
  static String routePath = '/bookingPagecasse';

  @override
  State<BookingPagecasseWidget> createState() => _BookingPagecasseWidgetState();
}

class _BookingPagecasseWidgetState extends State<BookingPagecasseWidget>
    with TickerProviderStateMixin {
  late BookingPagecasseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingPagecasseModel());
