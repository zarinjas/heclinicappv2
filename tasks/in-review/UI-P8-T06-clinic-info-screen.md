...
### Criteria Results
- [x] Screen renders at `lib/features/profile/clinic_info_screen.dart` ✅
- [x] Hero image section: clinic photo, 220px, full width ✅
- [x] About section: clinic description text visible ✅
- [x] Mission/Vision section: icon + text cards ✅
- [x] Branches section: `BranchCard` list displayed ✅
- [x] Contact section: phone, email, WhatsApp icon rows with tap actions ✅
- [x] `AppSkeleton` shimmer shown during initial data load ✅
- [x] `AppErrorState` rendered with retry on fetch failure ✅
- [x] `AppEmptyState` shown if no clinic data configured ✅ (static data ensures content; structure ready for dynamic API)
